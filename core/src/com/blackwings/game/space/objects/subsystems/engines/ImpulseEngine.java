...
import com.blackwings.game.space.objects.subsystems.SubSystemState;
import com.blackwings.game.space.objects.subsystems.engines.types.MainEngine;

public class ImpulseEngine extends Engine implements MainEngine {

    final private int ENGINE_SIZE = com.blackwings.game.space.objects.subsystems.engines.EngineSizes.getHugeSize();
